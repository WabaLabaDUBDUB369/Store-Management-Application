...
public class Product {
	...
	public static String[] columnNames = {"Product ID", "Name", "Price", "Available Qty"};
	...
	public void sellProduct(String uid, int amount) {
		...
		String query = "INSERT INTO purchaseinfo (userId, productId, amount, purchaseDate, cost) VALUES ('"+uid+"','"+this.productId+"',"+amount+", '"+date+"', "+(amount*this.price)+")";
		OracleConnection con = null;
        Statement st = null;
		System.out.println(query);
        try {
