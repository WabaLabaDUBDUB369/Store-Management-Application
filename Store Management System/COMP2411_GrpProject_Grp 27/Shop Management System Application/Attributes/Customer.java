...
public class Customer extends User {
	...
	public void updateCustomer(String name, int phone, String address) {
		String query = "UPDATE customer SET customerName='"+name+"', phoneNumber='+852"+phone+"', address='"+address+"' WHERE userId='"+this.userId+"'";
		OracleConnection con = null;
        Statement st = null;
		System.out.println(query);
        try {
	...
	public DefaultTableModel myProduct() {
		...
		String query = "SELECT purchaseinfo.purchaseId, purchaseinfo.productId, product.productName, purchaseinfo.cost, purchaseinfo.amount, purchaseinfo.purchaseDate FROM purchaseinfo, product WHERE (purchaseinfo.userId='"+this.userId+"' AND purchaseinfo.productId=product.productId) ORDER BY purchaseDate DESC";     
		OracleConnection con = null;
        Statement st = null;
		ResultSet rs = null;
		System.out.println(query);
        try {
			...
			while(rs.next()) {
				...
				String col6 = rs.getString("purchaseDate");
